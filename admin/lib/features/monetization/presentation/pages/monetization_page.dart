...
class _MonetizationPageState extends State<MonetizationPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _fetchMonetizationData() async {
    ...
    try {
      ...
      // Mock Fallback for local tests or connection issues
      setState(() {
        _revenueData = {
          'mrr': 10835.0,
          'arr': 130020.0,
          'active_subscribers': 465,
          'premium_conversion': 4.85,
          'segment_breakdown': {
            'subscriptions': 10835.0,
            'ads': 345.50,
            'tutor_commission': 484.20,
            'affiliates': 185.80,
            'certificates': 140.00,
          },
          'historical_reports': [
            {'report_date': '2026-06-06', 'mrr_cents': 850000},
            {'report_date': '2026-06-21', 'mrr_cents': 920000},
            {'report_date': '2026-07-06', 'mrr_cents': 985000},
          ]
        };
        _costData = {
        ...
        _creditData = {
          'total_circulating_credits': 14280,
          'total_transactions_count': 1850,
          'credit_distribution': {
            'monthly_grants': 65,
            'login_rewards': 15,
            'lesson_rewards': 10,
        ...
        _pendingTutors = [
          {
            'id': 'tutor_1',
            'user_profiles': {'full_name': 'Prof. Ananya Nair', 'email': 'ananya.nair@school.in'},
            'qualifications': 'PhD in Applied Linguistics, 10 yrs teaching IELTS students.',
          ...
          {
            'id': 'tutor_2',
            'user_profiles': {'full_name': 'James Miller', 'email': 'james.miller@ieltsclub.com'},
            'qualifications': 'BA in ESL Education, Cambridge CELTA certified.',
